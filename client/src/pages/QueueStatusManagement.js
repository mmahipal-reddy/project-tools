...
const QueueStatusManagement = () => {
  ...
  if (loading) {
    return (
      <div className="dashboard-layout">
        ...
        <div className="queue-status-management" style={{ marginLeft: sidebarOpen ? '320px' : '80px', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
  ...
  return (
    <div className="dashboard-layout">
      ...
      <div className="queue-status-management" style={{ marginLeft: sidebarOpen ? '320px' : '80px' }}>
